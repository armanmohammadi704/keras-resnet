...
class ResNet2D(keras.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        x = keras.layers.Conv3D(64, (7, 7,1), use_bias=False, name="conv111", padding="same")(x)
        x = keras.layers.Conv3D(64, (7, 7,1), use_bias=False, name="conv112", padding="same")(x)
        x = keras.layers.Conv3D(64, (7, 7,1), use_bias=False, name="conv113", padding="same")(x)
        x = keras.layers.Conv3D(64, (7, 7,1), use_bias=False, name="conv1333", padding="same")(x)
